        ...
        <div class="nav-area">
            ...
            <div class="d-flex justify-content-between">
                <div class="top-nav-bar d-flex">
                    ...
                    <div class="top-nav-item"><a><router-link to="faq"> Support</router-link></a></div>
                    <div class="top-nav-item"><a><router-link to="blogs">Blog</router-link></a></div>
                    <div class="top-nav-item"><a><router-link to="contact">Contact</router-link></a></div>
                    ...
                    <div class="side-menu-button fs-4 me-4">
                        ...
                        <div class="search-modal d-none" id="search-modal">
                            ...
                            <div>
                                ...
                                <button class="fw-bold"><a><router-link to="search">Find Now</router-link></a></button>
                            </div>
                        </div>
                    </div>
